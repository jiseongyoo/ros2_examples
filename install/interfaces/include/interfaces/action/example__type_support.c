...
#include <stddef.h>
#include "interfaces/action/example__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Example_Goal__rosidl_typesupport_introspection_c__Example_Goal_message_member_array[1] = {
  {
    "goal",  // name
    ...
    offsetof(interfaces__action__Example_Goal, goal),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_typesupport_introspection_c__MessageMember Example_Result__rosidl_typesupport_introspection_c__Example_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__action__Example_Result, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static rosidl_typesupport_introspection_c__ServiceMembers interfaces__action__example__rosidl_typesupport_introspection_c__Example_SendGoal_service_members = {
  "interfaces__action",  // service namespace
  "Example_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // interfaces__action__example__rosidl_typesupport_introspection_c__Example_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // interfaces__action__example__rosidl_typesupport_introspection_c__Example_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t interfaces__action__example__rosidl_typesupport_introspection_c__Example_SendGoal_service_type_support_handle = {
  0,
  &interfaces__action__example__rosidl_typesupport_introspection_c__Example_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, action, Example_SendGoal)() {
  if (!interfaces__action__example__rosidl_typesupport_introspection_c__Example_SendGoal_service_type_support_handle.typesupport_identifier) {
    interfaces__action__example__rosidl_typesupport_introspection_c__Example_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)interfaces__action__example__rosidl_typesupport_introspection_c__Example_SendGoal_service_type_support_handle.data;
  ...
  return &interfaces__action__example__rosidl_typesupport_introspection_c__Example_SendGoal_service_type_support_handle;
}
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers interfaces__action__example__rosidl_typesupport_introspection_c__Example_GetResult_service_members = {
  "interfaces__action",  // service namespace
  "Example_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // interfaces__action__example__rosidl_typesupport_introspection_c__Example_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // interfaces__action__example__rosidl_typesupport_introspection_c__Example_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t interfaces__action__example__rosidl_typesupport_introspection_c__Example_GetResult_service_type_support_handle = {
  0,
  &interfaces__action__example__rosidl_typesupport_introspection_c__Example_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, action, Example_GetResult)() {
  if (!interfaces__action__example__rosidl_typesupport_introspection_c__Example_GetResult_service_type_support_handle.typesupport_identifier) {
    interfaces__action__example__rosidl_typesupport_introspection_c__Example_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)interfaces__action__example__rosidl_typesupport_introspection_c__Example_GetResult_service_type_support_handle.data;
  ...
  return &interfaces__action__example__rosidl_typesupport_introspection_c__Example_GetResult_service_type_support_handle;
}
