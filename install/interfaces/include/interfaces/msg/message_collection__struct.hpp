...
#ifndef INTERFACES__MSG__MESSAGE_COLLECTION__STRUCT_HPP_
#define INTERFACES__MSG__MESSAGE_COLLECTION__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__interfaces__msg__MessageCollection __attribute__((deprecated))
#else
# define DEPRECATED__interfaces__msg__MessageCollection __declspec(deprecated)
#endif
...
struct MessageCollection_
{
  using Type = MessageCollection_<ContainerAllocator>;

  explicit MessageCollection_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit MessageCollection_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  // pointer types
  using RawPtr =
    interfaces::msg::MessageCollection_<ContainerAllocator> *;
  using ConstRawPtr =
    const interfaces::msg::MessageCollection_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<interfaces::msg::MessageCollection_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<interfaces::msg::MessageCollection_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      interfaces::msg::MessageCollection_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<interfaces::msg::MessageCollection_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<interfaces::msg::MessageCollection_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<interfaces::msg::MessageCollection_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<interfaces::msg::MessageCollection_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__interfaces__msg__MessageCollection
    std::shared_ptr<interfaces::msg::MessageCollection_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__interfaces__msg__MessageCollection
    std::shared_ptr<interfaces::msg::MessageCollection_<ContainerAllocator> const>
  ...
  bool operator==(const MessageCollection_ & other) const
  {
...
using MessageCollection =
  interfaces::msg::MessageCollection_<std::allocator<void>>;

// constant definitions
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>
MessageCollection_<ContainerAllocator>::CONSTANT_STRING = "CONSTANT_STRING";

}  // namespace msg

}  // namespace interfaces

#endif  // INTERFACES__MSG__MESSAGE_COLLECTION__STRUCT_HPP_
