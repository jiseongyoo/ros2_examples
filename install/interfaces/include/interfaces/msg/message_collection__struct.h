...
#ifndef INTERFACES__MSG__MESSAGE_COLLECTION__STRUCT_H_
#define INTERFACES__MSG__MESSAGE_COLLECTION__STRUCT_H_
...
static const char * const interfaces__msg__MessageCollection__CONSTANT_STRING = "CONSTANT_STRING";
...
enum
{
  interfaces__msg__MessageCollection__bounded_five_long_int_arr__MAX_SIZE = 5
};
// bounded_ten_char_string_t
enum
{
  interfaces__msg__MessageCollection__bounded_ten_char_string_t__MAX_STRING_SIZE = 10
};
// bounded_five_string_arr
enum
{
  interfaces__msg__MessageCollection__bounded_five_string_arr__MAX_SIZE = 5
};
// bounded_ten_char_unbounded_string_arr
enum
{
  interfaces__msg__MessageCollection__bounded_ten_char_unbounded_string_arr__MAX_STRING_SIZE = 10
};
// bounded_ten_char_bounded_five_string_arr
enum
{
  interfaces__msg__MessageCollection__bounded_ten_char_bounded_five_string_arr__MAX_SIZE = 5
};
// bounded_ten_char_bounded_five_string_arr
enum
{
  interfaces__msg__MessageCollection__bounded_ten_char_bounded_five_string_arr__MAX_STRING_SIZE = 10
};

// Struct defined in msg/MessageCollection in the package interfaces.
typedef struct interfaces__msg__MessageCollection
{
  bool bool_t;
  uint8_t byte_t;
  uint8_t char_t;
...
// Struct for a sequence of interfaces__msg__MessageCollection.
typedef struct interfaces__msg__MessageCollection__Sequence
{
  interfaces__msg__MessageCollection * data;
...
#endif  // INTERFACES__MSG__MESSAGE_COLLECTION__STRUCT_H_
