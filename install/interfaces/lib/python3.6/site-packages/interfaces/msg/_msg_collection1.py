...
class Metaclass_MsgCollection1(type):
    """Metaclass of message 'MsgCollection1'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interfaces.msg.MsgCollection1')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__msg_collection1
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__msg_collection1
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__msg_collection1
            cls._TYPE_SUPPORT = module.type_support_msg__msg__msg_collection1
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__msg_collection1
...
class MsgCollection1(metaclass=Metaclass_MsgCollection1):
    """Message class 'MsgCollection1'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.int_t = kwargs.get('int_t', int())
        self.uint_t = kwargs.get('uint_t', int())
    ...
    def __eq__(self, other):
        ...
        if self.short_uint_t != other.short_uint_t:
            return False
        if self.int_t != other.int_t:
            return False
        if self.uint_t != other.uint_t:
            return False
    ...
    def short_int_t(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'short_int_t' field must be an integer in [-128, 127]"
    ...
    def short_uint_t(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'short_uint_t' field must be an unsigned integer in [0, 255]"
    ...
    @int_t.setter
    def int_t(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'int_t' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'int_t' field must be an integer in [-32768, 32767]"
        self._int_t = value

    @property
    def uint_t(self):
        """Message field 'uint_t'."""
        return self._uint_t

    @uint_t.setter
    def uint_t(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'uint_t' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'uint_t' field must be an unsigned integer in [0, 65535]"
        self._uint_t = value
