...
bool interfaces__msg__message_collection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "interfaces.msg._message_collection.MessageCollection",
        full_classname_dest, 52) == 0);
  }
  interfaces__msg__MessageCollection * ros_message = _ros_message;
  {  // bool_t
...
{
  /* NOTE(esteve): Call constructor of MessageCollection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._message_collection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MessageCollection");
