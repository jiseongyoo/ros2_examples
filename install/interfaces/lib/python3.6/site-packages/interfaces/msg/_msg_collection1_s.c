...
bool interfaces__msg__msg_collection1__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "interfaces.msg._msg_collection1.MsgCollection1",
        full_classname_dest, 46) == 0);
  }
  interfaces__msg__MsgCollection1 * ros_message = _ros_message;
  {  // bool_t
  ...
  {  // short_int_t
    ...
    assert(PyLong_Check(field));
    ros_message->short_int_t = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // short_uint_t
    ...
    assert(PyLong_Check(field));
    ros_message->short_uint_t = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // int_t
    PyObject * field = PyObject_GetAttrString(_pymsg, "int_t");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->int_t = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // uint_t
    PyObject * field = PyObject_GetAttrString(_pymsg, "uint_t");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->uint_t = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // long_int_t
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * interfaces__msg__msg_collection1__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MsgCollection1 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._msg_collection1");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MsgCollection1");
  ...
  interfaces__msg__MsgCollection1 * ros_message = (interfaces__msg__MsgCollection1 *)raw_ros_message;
  {  // bool_t
    PyObject * field = NULL;
  ...
  {  // int_t
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->int_t);
    {
      int rc = PyObject_SetAttrString(_pymessage, "int_t", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // uint_t
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->uint_t);
    {
      int rc = PyObject_SetAttrString(_pymessage, "uint_t", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
