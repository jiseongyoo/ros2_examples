...
bool interfaces__srv__service_collection__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "interfaces.srv._service_collection.ServiceCollection_Request",
        full_classname_dest, 60) == 0);
  }
  interfaces__srv__ServiceCollection_Request * ros_message = _ros_message;
  {  // bool_t
...
{
  /* NOTE(esteve): Call constructor of ServiceCollection_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.srv._service_collection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServiceCollection_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool interfaces__srv__service_collection__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "interfaces.srv._service_collection.ServiceCollection_Response",
        full_classname_dest, 61) == 0);
  }
  interfaces__srv__ServiceCollection_Response * ros_message = _ros_message;
  {  // bool_t
    PyObject * field = PyObject_GetAttrString(_pymsg, "bool_t");
    if (!field) {
      return false;
...
{
  /* NOTE(esteve): Call constructor of ServiceCollection_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.srv._service_collection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServiceCollection_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
