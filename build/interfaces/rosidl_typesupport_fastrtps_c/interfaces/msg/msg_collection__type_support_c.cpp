...
#include "interfaces/msg/msg_collection__rosidl_typesupport_fastrtps_c.h"
...
using _MsgCollection__ros_msg_type = interfaces__msg__MsgCollection;

static bool _MsgCollection__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MsgCollection__ros_msg_type * ros_message = static_cast<const _MsgCollection__ros_msg_type *>(untyped_ros_message);
  // Field name: bool_t
  {
...
static bool _MsgCollection__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _MsgCollection__ros_msg_type * ros_message = static_cast<_MsgCollection__ros_msg_type *>(untyped_ros_message);
  // Field name: bool_t
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_interfaces__msg__MsgCollection(
  const void * untyped_ros_message,
...
static uint32_t _MsgCollection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__MsgCollection(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__MsgCollection(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _MsgCollection__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_interfaces__msg__MsgCollection(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MsgCollection = {
  "interfaces::msg",
  "MsgCollection",
  _MsgCollection__cdr_serialize,
  _MsgCollection__cdr_deserialize,
  _MsgCollection__get_serialized_size,
  _MsgCollection__max_serialized_size
};

static rosidl_message_type_support_t _MsgCollection__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MsgCollection,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, MsgCollection)() {
  return &_MsgCollection__type_support;
}
