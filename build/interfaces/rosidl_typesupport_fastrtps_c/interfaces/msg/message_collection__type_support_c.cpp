...
#include "interfaces/msg/message_collection__rosidl_typesupport_fastrtps_c.h"
...
using _MessageCollection__ros_msg_type = interfaces__msg__MessageCollection;

static bool _MessageCollection__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MessageCollection__ros_msg_type * ros_message = static_cast<const _MessageCollection__ros_msg_type *>(untyped_ros_message);
  // Field name: bool_t
  {
...
static bool _MessageCollection__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _MessageCollection__ros_msg_type * ros_message = static_cast<_MessageCollection__ros_msg_type *>(untyped_ros_message);
  // Field name: bool_t
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_interfaces__msg__MessageCollection(
  const void * untyped_ros_message,
...
static uint32_t _MessageCollection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__MessageCollection(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__MessageCollection(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _MessageCollection__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_interfaces__msg__MessageCollection(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MessageCollection = {
  "interfaces::msg",
  "MessageCollection",
  _MessageCollection__cdr_serialize,
  _MessageCollection__cdr_deserialize,
  _MessageCollection__get_serialized_size,
  _MessageCollection__max_serialized_size
};

static rosidl_message_type_support_t _MessageCollection__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MessageCollection,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, MessageCollection)() {
  return &_MessageCollection__type_support;
}
