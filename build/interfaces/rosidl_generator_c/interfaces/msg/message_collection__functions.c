...
interfaces__msg__MessageCollection__init(interfaces__msg__MessageCollection * msg)
{
  ...
  if (!rosidl_generator_c__int32__Sequence__init(&msg->unbounded_long_int_arr, 0)) {
    interfaces__msg__MessageCollection__fini(msg);
    return false;
  }
...
{
  interfaces__msg__MessageCollection * msg = (interfaces__msg__MessageCollection *)malloc(sizeof(interfaces__msg__MessageCollection));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interfaces__msg__MessageCollection));
  bool success = interfaces__msg__MessageCollection__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
interfaces__msg__MessageCollection__Sequence__init(interfaces__msg__MessageCollection__Sequence * array, size_t size)
{
  ...
  interfaces__msg__MessageCollection * data = NULL;
  if (size) {
    data = (interfaces__msg__MessageCollection *)calloc(size, sizeof(interfaces__msg__MessageCollection));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interfaces__msg__MessageCollection__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interfaces__msg__MessageCollection__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
interfaces__msg__MessageCollection__Sequence__fini(interfaces__msg__MessageCollection__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interfaces__msg__MessageCollection__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  interfaces__msg__MessageCollection__Sequence * array = (interfaces__msg__MessageCollection__Sequence *)malloc(sizeof(interfaces__msg__MessageCollection__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = interfaces__msg__MessageCollection__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    interfaces__msg__MessageCollection__Sequence__fini(array);
  }
  free(array);
}
