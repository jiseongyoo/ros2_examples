...
#ifndef INTERFACES__MSG__MSG_COLLECTION1__STRUCT_H_
#define INTERFACES__MSG__MSG_COLLECTION1__STRUCT_H_
...
enum
{
  interfaces__msg__MsgCollection1__bounded_five_long_int_arr__MAX_SIZE = 5
};
// bounded_ten_char_string_t
enum
{
  interfaces__msg__MsgCollection1__bounded_ten_char_string_t__MAX_STRING_SIZE = 10
};
// bounded_five_string_arr
enum
{
  interfaces__msg__MsgCollection1__bounded_five_string_arr__MAX_SIZE = 5
};
// bounded_ten_char_unbounded_string_arr
enum
{
  interfaces__msg__MsgCollection1__bounded_ten_char_unbounded_string_arr__MAX_STRING_SIZE = 10
};
// bounded_ten_char_bounded_five_string_arr
enum
{
  interfaces__msg__MsgCollection1__bounded_ten_char_bounded_five_string_arr__MAX_SIZE = 5
};
// bounded_ten_char_bounded_five_string_arr
enum
{
  interfaces__msg__MsgCollection1__bounded_ten_char_bounded_five_string_arr__MAX_STRING_SIZE = 10
};

// Struct defined in msg/MsgCollection1 in the package interfaces.
typedef struct interfaces__msg__MsgCollection1
{
  bool bool_t;
  uint8_t byte_t;
  uint8_t char_t;
...
// Struct for a sequence of interfaces__msg__MsgCollection1.
typedef struct interfaces__msg__MsgCollection1__Sequence
{
  interfaces__msg__MsgCollection1 * data;
...
#endif  // INTERFACES__MSG__MSG_COLLECTION1__STRUCT_H_
