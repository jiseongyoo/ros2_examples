...
#ifndef INTERFACES__MSG__MSG_COLLECTION1__STRUCT_HPP_
#define INTERFACES__MSG__MSG_COLLECTION1__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__interfaces__msg__MsgCollection1 __attribute__((deprecated))
#else
# define DEPRECATED__interfaces__msg__MsgCollection1 __declspec(deprecated)
#endif
...
struct MsgCollection1_
{
  using Type = MsgCollection1_<ContainerAllocator>;

  explicit MsgCollection1_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit MsgCollection1_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  // pointer types
  using RawPtr =
    interfaces::msg::MsgCollection1_<ContainerAllocator> *;
  using ConstRawPtr =
    const interfaces::msg::MsgCollection1_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<interfaces::msg::MsgCollection1_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<interfaces::msg::MsgCollection1_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      interfaces::msg::MsgCollection1_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<interfaces::msg::MsgCollection1_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<interfaces::msg::MsgCollection1_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<interfaces::msg::MsgCollection1_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<interfaces::msg::MsgCollection1_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__interfaces__msg__MsgCollection1
    std::shared_ptr<interfaces::msg::MsgCollection1_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__interfaces__msg__MsgCollection1
    std::shared_ptr<interfaces::msg::MsgCollection1_<ContainerAllocator> const>
  ...
  bool operator==(const MsgCollection1_ & other) const
  {
    ...
    if (this->int_t != other.int_t) {
      return false;
    }
    if (this->uint_t != other.uint_t) {
      return false;
    }
...
using MsgCollection1 =
  interfaces::msg::MsgCollection1_<std::allocator<void>>;
...
#endif  // INTERFACES__MSG__MSG_COLLECTION1__STRUCT_HPP_
