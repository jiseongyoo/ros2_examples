...
#include "interfaces/msg/msg_collection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::MsgCollection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::MsgCollection & ros_message)
{
  // Member: bool_t
  {
    uint8_t tmp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
max_serialized_size_MsgCollection(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::MsgCollection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::MsgCollection *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MsgCollection__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces::msg::MsgCollection *>(
...
{
  return max_serialized_size_MsgCollection(full_bounded, 0);
}

static message_type_support_callbacks_t _MsgCollection__callbacks = {
  "interfaces::msg",
  "MsgCollection",
...
static rosidl_message_type_support_t _MsgCollection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MsgCollection__callbacks,
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_MsgCollection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, MsgCollection)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_MsgCollection__handle;
}
