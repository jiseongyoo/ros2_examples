...
#include "interfaces/msg/message_collection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::MessageCollection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::MessageCollection & ros_message)
{
  // Member: bool_t
  {
    uint8_t tmp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
max_serialized_size_MessageCollection(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::MessageCollection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::MessageCollection *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MessageCollection__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces::msg::MessageCollection *>(
...
{
  return max_serialized_size_MessageCollection(full_bounded, 0);
}

static message_type_support_callbacks_t _MessageCollection__callbacks = {
  "interfaces::msg",
  "MessageCollection",
...
static rosidl_message_type_support_t _MessageCollection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MessageCollection__callbacks,
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_MessageCollection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, MessageCollection)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_MessageCollection__handle;
}
